...
📌 بعد التحليل، قم بتحويل الاستنتاج النهائي إلى كائن JSON موحّد على الشكل التالي:

{
  "buy": true | false,
  "confidence": "منخفض" | "متوسط" | "مرتفع",
  "reason": "شرح مختصر جداً للقرار"
}

🚨 ملاحظة: إذا لم تكن الصورة واضحة كليًا، افترض القيم بناءً على تجربتك وقدم أفضل تحليل ممكن. لا ترد برد تعليمي أو عام، بل التزم بالتحليل الفني العملي.
"""
